  ...
  return (
    <tr>
      ...
      <td className={`px-6 align-middle text-base whitespace-nowrap p-4`}>
        <span
          className={`flex items-center justify-center gap-2 text-${badgeColor}-900 bg-${badgeColor}-300 py-2 px-1 rounded-3xl`}
        >
          <span
            className={`h-2 w-2 block rounded-full bg-${badgeColor}-900`}
          ></span>
          {badgeContent}
        </span>
      </td>
